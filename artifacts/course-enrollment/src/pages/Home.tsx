        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20 lg:py-32">
          <div className="max-w-3xl">
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">Elevate Your Career.</span>
            </motion.h1>
            ...
            >
              Join thousands of students learning cutting-edge skills from industry experts. Premium courses, practical projects, and a community that pushes you forward.
            </motion.p>
            ...
            >
              <div className="flex items-center gap-2"><CheckCircle2 className="w-5 h-5 text-success" /> Lifetime Access</div>
              <div className="flex items-center gap-2"><CheckCircle2 className="w-5 h-5 text-success" /> Expert Mentors</div>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-border">
            <div className="flex flex-col items-center p-4">
              ...
              <h3 className="text-3xl font-display font-bold text-foreground mb-1">4.9/5</h3>
              <p className="text-muted-foreground font-medium">Average Course Rating</p>
            </div>
            <div className="flex flex-col items-center p-4">
              <div className="w-12 h-12 bg-accent/10 text-accent rounded-2xl flex items-center justify-center mb-4">
                <Users className="w-6 h-6" />
              </div>
              <h3 className="text-3xl font-display font-bold text-foreground mb-1">50k+</h3>
            ...
            <div className="flex flex-col items-center p-4">
              ...
              <h3 className="text-3xl font-display font-bold text-foreground mb-1">100+</h3>
              <p className="text-muted-foreground font-medium">Premium Courses</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <p className="text-muted-foreground max-w-2xl text-lg">Hand-picked by our experts to accelerate your learning journey today.</p>
            </div>
            <Link href="/courses">
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[1, 2, 3].map(i => (
                <div key={i} className="h-[400px] bg-muted/50 animate-pulse rounded-2xl border border-border/50" />
              ))}
            </div>
            ...
            <div className="text-center py-20 bg-card rounded-3xl border border-border">
              ...
              <p className="text-muted-foreground">Check back soon for amazing new content.</p>
            </div>
          )}
