        ...
        >
          <div className="mb-10">
            ...
            <p className="text-muted-foreground mt-2">
              {isRegister
                ? "Join thousands of learners elevating their skills."
          ...
          <div className="mt-8 text-center text-sm font-medium text-muted-foreground">
            ...
            <button
              onClick={() =>
                 window.location.href = isRegister ? "/auth" : "/auth?mode=register"
              }
        ...
        <div className="absolute bottom-16 left-16 right-16">
          <Card className="bg-background/10 backdrop-blur-xl border-white/10 text-white p-8">
            ...
            <h3 className="text-2xl font-display font-bold mb-2">
              "SkillElevate completely changed my career trajectory."
            </h3>
